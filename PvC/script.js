...
const light = new AnimeCard(17, "Light Yagami", 10, 05, 99, "../images/light.jpg");
const shikamaru = new AnimeCard(18, "Shikamaru", 47, 35, 80, "../images/shikamaru.jpg");
const madara = new AnimeCard(19, "Madara Uchiha", 78, 78, 78, "../images/madara.jpg");
const orochimaru = new AnimeCard(20, "Orochimaru", 47, 55, 66, "../images/orochimaru.jpg");
const itachi = new AnimeCard(21, "Itachi Uchiha", 70, 68, 54, "../images/itachi.jpg");
...
const natsu = new AnimeCard(24, "Natsu Dragneel", 39, 43, 23, "../images/natsu.jpg");
...
const tanjiro = new AnimeCard(28, "Tanjiro", 34, 34, 31, "../images/tanjiro.jpg");
const deku = new AnimeCard(29, "Deku", 35, 37, 48, "../images/deku.jpg");
const allMight = new AnimeCard(30, "All Might", 45, 50, 49, "../images/light.jpg");
